...
public class ParserServiceTest {
    ...
    public void shouldExecuteSnippet() {
        ...
        ExecuteResultDto result = Objects.requireNonNull(parserService.execute(1L, request).getBody()).data().data();
    ...
    public void shouldFormatSnippet() {
        ...
        FormattingResultDto result = Objects.requireNonNull(parserService.format(1L, request).getBody()).data().data();
    ...
    public void shouldLintCamelCaseSnippet() {
        ...
        String snippet = "println(\"Hello World\");";
        when (snippetService.getSnippet(1L)).thenReturn(Optional.of(snippet));
        LintingResultDto result = Objects.requireNonNull(parserService.lint(1L, request).getBody()).data().data();
